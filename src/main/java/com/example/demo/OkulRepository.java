...
public interface OkulRepository extends JpaRepository<tum_okullar, Integer> {
    ...
    @Query("select o from tum_okullar o where o.puan_2023 < :puan  and o.puan_turu='SAY' and o.puan_2023 != -1 and o.bolum_adi=:bolum_adi order by o.puan_2023 desc")
    List<tum_okullar> findByPuan2023LessThan(@Param("puan") int puan,@Param("bolum_adi") String bolum_adi);

    @Query("select o from tum_okullar o  where o.puan_2022<:puan and o.puan_turu='SAY' and  o.puan_2022!=-1 and o.bolum_adi=:bolum_adi order by o.puan_2022 desc")
    List<tum_okullar> findByPuan2022LessThan(@Param("puan") int puan,@Param("bolum_adi") String bolum_adi);

    @Query("select o from tum_okullar o  where o.puan_2021<:puan and o.puan_turu='SAY' and  o.puan_2021!=-1 and o.bolum_adi=:bolum_adi order by o.puan_2021 desc")
    List<tum_okullar> findByPuan2021LessThan(@Param("puan") int puan,@Param("bolum_adi") String bolum_adi);

    @Query("select o from tum_okullar o  where o.puan_2020<:puan and o.puan_turu='SAY' and  o.puan_2020!=-1 and o.bolum_adi=:bolum_adi order by o.puan_2020 desc")
